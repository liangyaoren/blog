    ...
    <nav class="navbar navbar-default">
        <div class="container-fluid" style="background-color: #303643 !important">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="${base}/index" style="color: white">Yaoren's Blog--notejava</a>
            </div>
            ...
            <div class="collapse navbar-collapse navbar-right" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav">
                    ...
                    <li><a href="http://blog.notejava.com/blog/47" style="color: white">关于notejava</a></li>
